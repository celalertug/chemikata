...
describe('test form validation', () => {
  ...
  it('should create invalid', async function () {
    try {
      await axios.post(`${URL}/`, {id: 4, name: "user4", age: 5, email: "adam@mail.com", sex: "male1"});
  ...
  it('should update error', async function () {
    let res;
    try {
      res = await axios.put(`${URL}/1`, {age: 32, alive: false});
      console.log(res.data);
    } catch (err) {
  ...
  it('should update error2', async function () {
    try {
